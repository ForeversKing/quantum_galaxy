...
def get_symbol(num_classes, bn_mom=0.99, **kwargs):
    ...
    pool3 = mx.symbol.Pooling(
             data=relu5_1, pool_type="avg", kernel=(5, 2), stride=(3, 1), name="pool3")

    fc6 = mx.symbol.Convolution(
        data=pool3, kernel=(1, 5), stride=(1, 1), num_filter=4096, name="conv_fc6")
    ...
    apool6 = mx.symbol.Pooling(
         data=relu6, pool_type="avg", kernel=(9, 1), stride=(1, 1), name="apool6")
